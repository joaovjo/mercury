...
export const PROVIDERS: Record<string, AcpProvider> = {
  ...
  "claude-acp": {
    ...
    command: (_cwd, model) => {
      ...
      return { cmd: ["bunx", "@agentclientprotocol/claude-agent-acp@latest"], env };
    },
  },
  "codex-acp": {
    id: "codex-acp",
  ...
  "grok-build": {
    ...
    command: (_cwd, model) => {
      ...
      return { cmd: ["bunx", "@xai-official/grok@latest", "agent", "stdio"], env };
    },
  },
  "mistral-vibe": {
    id: "mistral-vibe",
  ...
  "qwen-code": {
    ...
    command: (_cwd, model) => {
      ...
      return { cmd: ["bunx", "@qwen-code/qwen-code@latest", "--acp", "--experimental-skills"], env };
    },
  },
  "glm-acp-agent": {
    id: "glm-acp-agent",
  ...
  "agoragentic-acp": {
    ...
    models: ["default"],
    defaultModel: undefined,
    command: (_cwd, _model) => ({ cmd: ["bunx", "agoragentic-mcp@latest", "--acp"] }),
  },
  "amp-acp": {
    id: "amp-acp",
    displayName: "Amp",
  ...
  auggie: {
    ...
    defaultModel: undefined,
    command: (_cwd, _model) => ({ cmd: ["bunx", "@augmentcode/auggie@latest", "--acp"] }),
  },
  autohand: {
    id: "autohand",
    ...
    models: ["default"],
    defaultModel: undefined,
    command: (_cwd, _model) => ({ cmd: ["bunx", "@autohandai/autohand-acp@latest"] }),
  },
  "codebuddy-code": {
    id: "codebuddy-code",
    ...
    defaultModel: undefined,
    command: (_cwd, _model) => ({ cmd: ["bunx", "@tencent-ai/codebuddy-code@latest", "--acp"] }),
  },
  "cortex-code": {
    id: "cortex-code",
  ...
  "factory-droid": {
    ...
    models: ["default"],
    defaultModel: undefined,
    command: (_cwd, _model) => ({ cmd: ["bunx", "droid@latest", "exec", "--output-format", "acp-daemon"] }),
  },
  "fast-agent": {
    id: "fast-agent",
  ...
  kilo: {
    ...
    models: ["default"],
    defaultModel: undefined,
    command: (_cwd, _model) => ({ cmd: ["bunx", "@kilocode/cli@latest", "acp"] }),
  },
  "minion-code": {
    id: "minion-code",
  ...
  nova: {
    ...
    models: ["default"],
    defaultModel: undefined,
    command: (_cwd, _model) => ({ cmd: ["bunx", "@compass-ai/nova@latest", "acp"] }),
  },
  "pi-acp": {
    id: "pi-acp",
    displayName: "Pi ACP",
  ...
  qoder: {
    ...
    models: ["default"],
    defaultModel: undefined,
    command: (_cwd, _model) => ({ cmd: ["bunx", "@qoder-ai/qodercli@latest", "--acp"] }),
  },
  sigit: {
    id: "sigit",
...
async function listOpenCodeModels(): Promise<string[]> {
  try {
    ...
    const out = (await $`opencode models`.timeout(MODELS_SPAWN_TIMEOUT_MS).text()).trim();
