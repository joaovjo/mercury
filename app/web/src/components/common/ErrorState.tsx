  ...
  return (
    <div className="rounded-xl border border-destructive/50 bg-destructive/5 p-6 shadow-xs">
      <div className="flex items-center gap-2 text-destructive font-semibold">
        ...
        <span>
          <FormattedMessage id="common.error.title" defaultMessage="Couldn't load this section." />
        </span>
      </div>
      ...
      <p className="text-muted-foreground text-xs mt-2">
        <FormattedMessage
          id="common.error.hint"
          defaultMessage="If this persists, make sure the LinkedIn MCP is reachable and you're logged in to LinkedIn in your browser session, then retry."
        />
      </p>
      {onretry && (
        <Button
