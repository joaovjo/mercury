        ...
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            >
              ...
              <div className="z-10">
                <h3 className="text-sm font-medium text-muted-foreground flex items-center gap-2">
                  <GaugeIcon className="size-5 text-primary" /> Profile Score
                </h3>
                <p className="text-xs text-muted-foreground mt-1">Recruiter-search visibility</p>
              </div>
              <div className="mt-8 z-10 flex items-baseline gap-2">
                {score != null ? (
                  ...
                  <span className="text-2xl font-semibold text-muted-foreground">Not scanned</span>
                )}
              </div>
            ...
            >
              <div className="text-xs text-muted-foreground font-medium flex items-center gap-2">
                <UsersIcon className="size-4 text-muted-foreground" /> Recruiters
              </div>
            ...
            <div className="rounded-xl border border-border bg-card p-5 flex flex-col justify-between shadow-xs">
              <div className="text-xs text-muted-foreground font-medium flex items-center gap-2">
                <CheckCircleIcon className="size-4 text-emerald-500" /> Accepted
              </div>
            ...
            <div className="rounded-xl border border-border bg-card p-5 flex flex-col justify-between shadow-xs">
              <div className="text-xs text-muted-foreground font-medium flex items-center gap-2">
                <ArrowBendUpLeftIcon className="size-4 text-primary" /> Replied
              </div>
            ...
            >
              <div className="text-xs font-semibold text-primary flex items-center gap-2">
                <VideoCameraIcon className="size-4" /> Interviews
              </div>
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="text-sm font-semibold text-foreground">Jobs Saved</div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {breakdown.length > 0 && (
              <div className="rounded-xl border border-border bg-card p-6 shadow-xs">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-base font-semibold text-foreground">Profile breakdown</h3>
                  <button
            ...
            <div className="rounded-xl border border-border bg-card p-6 flex flex-col justify-between shadow-xs">
              <div>
                <h3 className="text-base font-semibold text-foreground mb-4">Pipeline health</h3>
                <div className="p-4 rounded-lg bg-muted/40 border border-border text-sm leading-relaxed text-muted-foreground">
                  <strong className="text-foreground font-semibold">{ov.recruiters} recruiters</strong> contacted ·{" "}
                  <strong className="text-emerald-500 font-semibold">{ov.accepted} accepted</strong> ·{" "}
                  <strong className="text-primary font-semibold">{ov.replied} replied</strong> ·{" "}
                  <strong className="text-primary font-semibold">{ov.interviews} interviews</strong> scheduled.
                  {score === null && (
                    <p className="mt-2 text-xs text-muted-foreground">
                      Run a profile scan to capture your first score and breakdown.
                    </p>
                  )}
                </div>
              </div>
              <Button className="w-full mt-6" onClick={() => onnav("profile")}>
                <ScanIcon className="size-4 mr-1.5" /> Scan profile
              </Button>
            </div>
          </div>
        </>
